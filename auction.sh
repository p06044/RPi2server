...
#ページリンクパート
echo "<a href=\"amazonlist.html\">[ama]</a><a href=\"cron.html\">[cron]</a><span style=\"color:orange;\">[meru]</span><a href=\"ya.html\">[yauc]</a><a href=\"timer.html\">[timer]</a><a href=\"button.html\">[button]</a>" >> /home/pi/auctionlist.html
RET='\
'
