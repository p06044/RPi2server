...
if tokumei == "y":
	if post == "f" or post == "y":
		if tateyoko == "1" or tateyoko == "2":
			if takasa == "1":
				...
				if sum == "1" and (weight == "1" or weight == "2" or weight == "3" or weight == "4" or weight == "5"):
					print "宅急便60サイズ"
				elif sum == "2" and weight == "8":
					print "宅急便80サイズ"
				elif sum == "3" and weight == "9":
					print "宅急便100サイズ"
				elif sum == "4" and weight == "10":
					print "宅急便120サイズ"
				elif sum == "5" and weight == "11":
					print "宅急便140サイズ"
				elif sum == "6" and weight == "12":
					print "宅急便160サイズ"
				elif sum == "7" and weight == "13":
					print "大型らくらくメルカリ便"
				else:
					print "取り扱えません"
	elif post == "r":
		if tateyoko == "1" or tateyoko == "2":
			...
			elif sum == "1" and (weight == "1" or weight == "2" or weight == "3" or weight == "4" or weight == "5" or weight == "6" or weight == "7" or weight == "8" or weight == "9" or weight == "10" or weight == "11" weight == "12"):
				print "ゆうパック60サイズ"
			elif sum == "2" and (weight == "1" or weight == "2" or weight == "3" or weight == "4" or weight == "5" or weight == "6" or weight == "7" or weight == "8" or weight == "9" or weight == "10" or weight == "11" weight == "12"):
				print "ゆうパック80サイズ"
			elif sum == "3" and (weight == "1" or weight == "2" or weight == "3" or weight == "4" or weight == "5" or weight == "6" or weight == "7" or weight == "8" or weight == "9" or weight == "10" or weight == "11" weight == "12"):
				print "ゆうパック100サイズ"
			else:
				print "取り扱えません"
		else:
	...
	if weight == "1" or weight == "2":
		...
		if (tateyoko == "1" or tateyoko == "2") and (weight == "1" or weight == "2" or weight == "3" or weight == "4" or weight == "5" or weight == "6" or weight == "7"):
